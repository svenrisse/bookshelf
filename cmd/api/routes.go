...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodGet, "/v1/:userid/books")
	router.HandlerFunc(http.MethodPost, "/v1/:userid/books")
	router.HandlerFunc(http.MethodPatch, "/v1/:userid/books/:bookid")
	router.HandlerFunc(http.MethodDelete, "/v1/:userid/books/:bookid")
